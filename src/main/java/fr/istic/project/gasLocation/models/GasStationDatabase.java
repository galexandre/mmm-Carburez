...
public class GasStationDatabase extends OrmLiteSqliteOpenHelper {
	 ...
	 * @throws IOException
	 */
	public static synchronized GasStationDatabase getGasStationDatabase(
	...
	public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
		/*try {
			...
			Gas gas = new Gas();
			dao.create(gas);
			Log.i(GasStationDatabase.class.getName(),
					"created new entries in onCreate: " + millis);
		} catch (SQLException e) {
			Log.e(GasStationDatabase.class.getName(), "Can't create database",
					e);
	 ...
	 */
	public Dao<Gas, Long> getGasDao() throws SQLException,
	 ...
	 * @throws java.sql.SQLException
	 */
	public Dao<Station, Long> getStationDao() throws SQLException,
			java.sql.SQLException {
		if (stationDao == null) {
